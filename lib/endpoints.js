/** List of API endpoints jsraw knows about
 * Inspired from: https://github.com/praw-dev/praw/blob/master/praw/endpoints.py
 */
 ...
 * Usage example:
 * 
 * const { API_PATH } = require('endpoints.js_PATH');
...
const API_PATH = {
  ...
  "reddit_post": "/r/{subreddit}/comments/{article}",
...
module.exports.API_PATH = API_PATH;