...
class OAuth extends OAuthBase {
  ...
  */
   ...
   * @param tokenType 'Bearer' by default
  */
  async postData(endPoint, data = {}, tokenType = 'Bearer') {
    return await this.post(this.accessToken, 'https://oauth.reddit.com' + endPoint, data, tokenType);
  }
  ...
  */
  async getAccessToken(writeToFile = { do: false, filePath: '' }) {
    ...
    return await this.post(authToken, accessTokenUrl, reqBody, 'Basic')
      .then(data => {
